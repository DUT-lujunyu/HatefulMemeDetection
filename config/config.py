...
class Config_base(object):
    ...
    def __init__(self, model_name, task_name):
        ...
        self.train_path = path.dirname(path.dirname(__file__)) + '/resource/hateful_memes/train_bak.csv'                                # 训练集
        self.dev_path = path.dirname(path.dirname(__file__)) + '/resource/hateful_memes/test_bak.csv'   
        self.test_path = path.dirname(path.dirname(__file__)) + '/resource/hateful_memes/test_bak.csv'
        
        self.result_path = path.dirname(path.dirname(__file__))+'/result'  
        self.prediction_path = path.dirname(path.dirname(__file__))+'/prediction'                          
...
class Config_prompthate(Config_base):
    ...
    def __init__(self, model_name, task_name):
        ...
        self.template = 0  # 使用的 template 1
